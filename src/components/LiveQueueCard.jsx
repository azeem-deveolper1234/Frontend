  ...
  const getProximityConfig = () => {
    if (status === 'serving' || peopleAhead === 0) {
      return {
        ...
        badge: 'Your Turn',
        alertMsg: 'Aapki turn aa gayi hai! Proceed inside now. 🏃‍♂️',
        icon: CheckCircle2,
    ...
    if (peopleAhead <= 2) {
      return {
        ...
        badge: 'Very Close',
        alertMsg: 'Aapki turn bohot kareeb hai. Be ready outside! 🚨',
        icon: AlertTriangle,
    ...
    if (peopleAhead <= 5) {
      return {
        ...
        badge: 'Approaching',
        alertMsg: 'Aapki turn aane wali hai. Be ready shortly.',
        icon: Info,
    ...
    return {
      ...
      badge: 'Waiting',
      alertMsg: 'Aap abhi line mein hain. Sabr se intezar karein.',
      icon: Info,
